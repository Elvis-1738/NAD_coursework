   ...
   <div class="col-lg-3" style="margin-bottom:10px">
    ...
    <div class="card-body justify-content-center">
        ...
        <%}%>
         ...
         <a href="like_product?like_product=true&product_id=<%=rs.getString("product_id")%>"> <button type="submit" name="store_product" class="btn btn-warning">Like</button></a>
